...
const Description = (props) => {
    ...
    return (
        <div className="">
            <div className="mx-5 mt-5 p-6 border-2 rounded-lg grid md:grid-rows-4 lg:grid-cols-4 justify-center">
                ...
                <div className="border-2 col-span-1 p-4 text-center">
                    ...
                    <h3 className="text-end me-2">{fare}</h3>
                    <div className="grid grid-cols-3 mb-2 border-2">
                        <h2 className="col-span-2" >Advance:</h2>
                        <h2 className="col-span-1 text-end me-2">{advance ? advance : 0}</h2>
                    </div>
                    <div className="border-2 grid grid-cols-3">
                        <h2 className="col-span-2" >Net Fare:</h2>
                        <h2 className="col-span-1 text-end me-2 font-bold">{fare - advance}</h2>
                    </div>
                </div>
            </div>
        </div>
