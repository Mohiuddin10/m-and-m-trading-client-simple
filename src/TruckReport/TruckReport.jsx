...
const TruckReport = () => {
  ...
  return (
    <div className="">
      <form
        className="text-center sm:flex-col md:flex-row align-middle justify-center items-center my-4"
        action=""
      ...
      >
        ...
        <input
          ...
          id="date"
        />
        <button type="submit" className="btn btn-wide m-2">
          Done
        </button>
      </form>
      <div className="">
      ...
      <h2 className="text-center m-8">
        This is auto generated report and doesn't require any signature
      </h2>
    </div>
  );
};
